...
public final class ErrorMessage {    
    ...
    public static final String VAL_CODE_SIZE    = "会員コードは" + ValidationConstraints.CODE_MIN + "〜" + ValidationConstraints.CODE_MAX + "文字で指定してください。";
    public static final String VAL_NAME_NOT_BLANK     = "会員名は必須です。";
    public static final String VAL_NAME_SIZE    = "会員名は" + ValidationConstraints.NAME_MIN + "〜" + ValidationConstraints.NAME_MAX + "文字で指定してください。";
